...
3) Теперь выберите способ задания графа(выберите ввести граф вручную) и введите рёбра в формате (начальная вершина, конечная вершина, вес):

![6](/img/s3.png)



4) Введите точку входа в граф и наблюдайте результат:
