...
* [`gtest`](https://github.com/mkildishev/mp2-lab4-graph/tree/graph/gtest) - библиотека GoogleTest.
* [`include`](https://github.com/mkildishev/mp2-lab4-graph/tree/graph/include) - каталог для размещения заголовочных файлов и реализаций структур данных.
* [`sample_Dijkstra`](https://github.com/mkildishev/mp2-lab4-graph/tree/graph/sample-Dijkstra) - каталог для размещения исходного кода приложения алгоритма Дейкстры.
* [`sample_Kruskal`](https://github.com/mkildishev/mp2-lab4-graph/tree/graph/sample-Kruskal) - каталог для размещения исходного кода приложения алгоритма Краскала.
* [`sample_sort`](https://github.com/mkildishev/mp2-lab4-graph/tree/graph/sample-sort) - каталог для размещения исходного кода приложения пирамидальной сортировки.
* [`test`](https://github.com/mkildishev/mp2-lab4-graph/tree/graph/test) - каталог для размещения тестов.
* [`sln`](https://github.com/mkildishev/mp2-lab4-graph/tree/graph/sln/vc14) - каталог с файлими решений.
* [`img`](https://github.com/mkildishev/mp2-lab4-graph/tree/graph/img) - каталог с изображениями для отчета;
* [`src`](https://github.com/mkildishev/mp2-lab4-graph/tree/graph/src) - каталог для размещения реализационных файлов
